...
const Details: FunctionComponent<Props> = ({
  ...
  const [displayFirstNameMessage, setDisplayFirstNameMessage] = useState<boolean>(false);
  const [displayLastNameMessage, setDisplayLastNameMessage] = useState<boolean>(false);  
